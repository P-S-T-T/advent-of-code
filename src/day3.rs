...
fn main() {
  ...
  // test_ride_part1(&test_forrest_map);
  println!("Answer of Part 1 is: {}", part1(&forrest_map));
  test_ride_part2(&test_forrest_map);
  println!(
    "Answer of Part 2 is: {}",
    part2(
      &forrest_map,
...
fn test_ride_part1(test_forrest_map: &[&str]) {
...
fn ride(forest_map: &[&str], slope: &Slope) -> usize {
  let re = forest_map
    .iter()
    .enumerate()
    .skip(slope.down)
...
fn part1(forest_map: &[&str]) -> usize {
  ride(forest_map, &Slope { down: 1, right: 3 })
}

fn test_ride_part2(test_forrest_map: &[&str]) {
  let slopes = [
    Slope { down: 1, right: 1 },
    Slope { down: 1, right: 3 },
    Slope { down: 1, right: 5 },
  ...
  assert_eq!(336, part2(test_forrest_map, &slopes))
}

fn part2(forest_map: &[&str], slopes: &[Slope]) -> usize {
